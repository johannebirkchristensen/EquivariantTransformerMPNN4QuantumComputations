...
config = {
    ...
    'save_dir':    os.path.join(_BASE, 'models/trained_models/MatPES/GATAall2all'),
    ...
    'force_loss_weight':  1.0, # was 1 
    'stress_loss_weight': 0.1,
    'use_global_attn':  True,
    'global_attn_rope': True,

    # ── Training ──────────────────────────────────────────────────
    'epochs':               30,        # PES datasets converge faster
    'batch_size':           16,         # smaller: each structure has ~30 atoms → big graphs
    'learning_rate':        5e-5, # was for no explod NAN 5e-5
    'weight_decay':         1e-2, # was for no explod NAN 1e-2
    'gradient_clip_norm':   1.0, # was for no explod NAN: 1.0 
    ...
    'n_atom_basis':           128, # it is 256 in gotennet... but it might be the same as some of the others.. ( attn hidden channels... so )
    'aggr':                   'add',
    'bias_init':              'zeros',
    # ── Model settings ─────────────────────────────────────────────
    ...
    'use_gate_act':               False,
    'use_grid_mlp':               False,
    'use_sep_s2_act':             True, # True for equiformerV2 up on the sphere type shi. 
