...
from equiformerv2_MatPES_GATAV2_no_normalize_attn_output import EquiformerV2_MatPES
...
def main():
    ...
    run = wandb.init(
        ...
        config=config,
        name=config.get('wandb_run_name', 'equiformerv2-gata-matpes_Matpes_30_epochs_GATA__no_norm_of_atten_output'),
