...
from NewFunctions.GATA_and_all2all.activation import HTR, GATAValueActivation, GlobalNodeAttention, GlobalNodeAttentionFullEquivariant
...
class EquiformerV2_MatPES(BaseModel, nn.Module):
    ...
    def __init__(
        ...
        if use_global_attn:
            self.global_attn = GlobalNodeAttentionFullEquivariant(
    ...
    def forward(self, data):
        ...
        x.embedding = self.global_attn(x.embedding, data['batch'])
