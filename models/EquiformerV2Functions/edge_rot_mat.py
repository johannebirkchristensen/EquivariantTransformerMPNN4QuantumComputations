...
#For each edge, it builds a local 3D coordinate frame whose x-axis points along 
# the edge direction.
#self.SO3_rotation[i].set_wigner(edge_rot_mat)... so it uses the wigner rotation matrix 
# to initialize the wigner D matrix for rotations of the spherical harmonics associated to that edge.
# ( Agian for SO(2) rotations around the edge axis)
