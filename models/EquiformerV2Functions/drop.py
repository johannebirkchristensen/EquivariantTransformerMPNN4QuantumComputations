...
'''
# This file implements different dropout and stochastic depth (DropPath) variants,
# including versions adapted for graphs and SO(3)-equivariant features. The goal is
# to regularize the network by randomly dropping entire residual paths, whole graphs,
# or entire irreducible representation blocks while preserving equivariance.
